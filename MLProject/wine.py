...
# first hidden layer has 8 nodes
my_model.add(tf.keras.layers.Dense(8, activation="relu",input_shape=(13,)))

# second hidden layer has 6 nodes
my_model.add(tf.keras.layers.Dense(6,activation="relu"))

# third hidden layer has 3 nodes
my_model.add(tf.keras.layers.Dense(3,activation="relu"))
