...
my_batch_size = 32
my_epochs = 1000
my_optimizer = tf.train.AdamOptimizer(learning_rate=0.4)
...
# first hidden layer has 10 nodes with activation relu
my_model.add(tf.keras.layers.Dense(10, activation="relu", input_shape=(30,)))


# second layer - dropout layer
my_model.add(tf.keras.layers.Dense(8, activation="relu"))
my_model.add(tf.keras.layers.Dropout(0.4)) # dropout 0.4. Retain: 0.6
